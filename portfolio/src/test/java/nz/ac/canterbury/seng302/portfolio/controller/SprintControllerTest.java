...
class SprintControllerTest {
    ...
    public void beforeEach() {
        ...
        sprint.setParentProjectId(PROJECT_ID);
...
//                        .param("sprintName", "Test Sprint")
//                        .param("sprintDescription", "Test description")
//                        .param("sprintStartDate", "2022-09-09")
//                        .param("sprintEndDate", "2022-10-09"))
//                .andExpect(status().isOk());
//    }
