...
public class GlobalVars {
    ...
    public static final String DESC_ERROR_MESSAGE = "Description can only have letters, numbers, punctuation, and spaces.";
    public static final String NAME_ERROR_MESSAGE = "Name can only have letters, numbers, punctuation except commas, and spaces.";
