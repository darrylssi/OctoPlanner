...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let calendar = new FullCalendar.Calendar(calendarEl, {
        ...
        eventOrder: "id", // TODO make a function that always orders the icon ids before sprint ids
        ...
        eventClick: function(info) {
            if (sprintsEditable === "true" && info.event.type === 'sprint') {
...
//            let icon = document.createElement('i')
            ...
            switch(arg.event.extendedProps.type) {
                case 'event':
                    ...
                    break;
                case 'milestone':
                    return { html: milestoneIcon }
                    break;
                case 'deadline':
                    return { html: deadlineIcon }
                    break;
                default:
                    return {html: arg.event.el.innerHTML};
            }
