...
public class ListUsersController {
    ...
    private static final String COOKIE_NAME = "page_order";
    ...
    public String GetListOfUsers(
        ...
        Pair<String, Boolean> ordering = getPageOrdering(request);
        ...
        try {
            ...
            CookieUtil.clear(response, COOKIE_NAME);
    ...
    public String changeUserListOrdering(
        ...
        Cookie cookie = new Cookie(COOKIE_NAME, orderBy + ':' + strDirection);
     ...
     */
    private static Pair<String, Boolean> getPageOrdering(HttpServletRequest request) {
        final Pair<String, Boolean> DEFAULT_VALUES = Pair.of(DEFAULT_ORDER_COLUMN, DEFAULT_IS_ASCENDING);
        
        String value = CookieUtil.getValue(request, COOKIE_NAME);
