...
public class Event {
     ...
     * Specifically, this function takes colour from the earliest sprint that
     * overlaps with it,
     * or returns a system default if no sprints overlap with this event.
     * 
    ...
    public String determineColour(List<Sprint> sprints) {
        ...
        // Tracks the earliest point of overlap to get colour from the first sprint
        // overlapping chronologically
        ...
        for (Sprint checkedSprint: sprints) {
            ...
            /*
             * Sprints are assumed to be active on their end date, so we also check for
             * equality
             */
