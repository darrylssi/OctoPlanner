...
/**
 * A message object to be sent through websockets when a schedulable is updated. TODO
...
public class SprintMessageOutput {
     ...
     */
    public SprintMessageOutput(Schedulable schedulable, List<Sprint> sprints, List<Schedulable> schedulables) {
